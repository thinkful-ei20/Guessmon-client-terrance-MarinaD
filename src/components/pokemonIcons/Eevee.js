...
export default function Eevee(props) {
  return (
    <svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 127.6 127.6" style={{enableBackground: 'new 0 0 127.6 127.6'}} xmlSpace="preserve" width="127.6" height="127.6" {...props}>
      <g>
        <g>
