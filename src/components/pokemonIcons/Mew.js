...
export default function Mew(props) {
  return (
    <svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 127.318 127.318" style={{enableBackground: 'new 0 0 127.318 127.318'}} xmlSpace="preserve" width="127.318" height="127.318" {...props}>
      <g>
        <g>
          <g>
